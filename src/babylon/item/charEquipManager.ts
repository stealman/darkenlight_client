...
export const CharEquipManager = {
    ...
    async initialize(scene: Scene) {
        const helmModels = [
            new WearableItemModel("male-plate-helm1", 1, "helm1.babylon", new Vector3(0.46, 0.46, 0.46), new Vector3(0, 0.44, 0)),
        ...
        const armorModels = [
            new WearableItemModel("male-plate-armor", 1, "armor-plate.babylon", new Vector3(0.42, 0.42, 0.42), new Vector3(-0.01, 0.65, 0.03))]
