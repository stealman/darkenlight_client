...
export const CbHelmets = {
    PLATE_ARMOR_SKELETON: new MobEquipItemData(1100, "1100_armor_skeleton", "armor-plate", "plate", new Vector3(0, 0.45, 0), new Vector3(0, Math.PI / 2, 0), new Vector3(0.36, 0.20, 0.3), 4, 4),
    HELM_SKELETON: new MobEquipItemData(1850, "1850_helm_skeleton", "helmet", "plate", new Vector3(0, 0.45, 0), new Vector3(0, Math.PI / 2, 0), BabylonUtils.getSymVector(0.40), 4, 4),
}
