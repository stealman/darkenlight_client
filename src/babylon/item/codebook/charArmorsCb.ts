...
export const CharArmorsCbManager = {
    ...
    initBasicMetalArmorModels() {
        this.basicMetalArmorModels = [
            ...
            new CharWearableItemModel("male-plate-pauldron-left", 40, this.BASE_ARMORS_PATH + "male-pauldron-plate.babylon", new Vector3(0.48, 0.48, 0.54), new Vector3(-0.01, -0.12, 0.065), new Vector3(0, -Math.PI / 2, 0)),
            new CharWearableItemModel("male-plate-pauldron-right", 50, this.BASE_ARMORS_PATH + "male-pauldron-plate.babylon", new Vector3(0.48, 0.48, 0.54), new Vector3(-0.01, -0.12, -0.05), new Vector3(0, Math.PI / 2, 0)),
