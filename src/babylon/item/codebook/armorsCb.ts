...
export const ArmorsCbManager = {
    ...
    async getItem(data: EquipItemData): Promise<MobEquipItemType> {
...
export const CbArmorTypes = {
    PLATE_ARMOR_MALE: new EquipItemData(100, "100_male-armor-plate", "male-armor-plate", PLATE_METAL_BASIC, new Vector3(-0.01, 0.65, 0.03), new Vector3(0.42, 0.42, 0.44),
        4, 4, false, null),

    HELM_MALE: new EquipItemData(200, "200_male-helmet", "male-helmet", PLATE_METAL_BASIC, new Vector3(0, 0.47, 0), BabylonUtils.getSymVector(0.44),
        4, 4, false, null),

    HELM_MALE_CLOSED: new EquipItemData(210, "210_male-helmet-closed", "male-helmet_closed", PLATE_METAL_BASIC, new Vector3(0, 0.42, 0), BabylonUtils.getSymVector(0.44),
        4, 4, false, null),

    PAULDRON_MALE: new EquipItemData(300, "300_male-pauldron", "male-pauldron-plate", PLATE_METAL_BASIC, new Vector3(0.06, -0.13, 0.02), new Vector3(0.48, 0.48, 0.58),
        4, 4, false, null),

    LEG_MALE: new EquipItemData(400, "400_male-leg-plate", "male-leg-plate", PLATE_METAL_BASIC, new Vector3(-0.01, -0.1, 0.01), new Vector3(0.26, 0.26, 0.23),
        4, 4, false, null),
}
