...
export const MaceVertexColorPalettes: Record<string, VertexColorWeaponPalette> = {
    ...
    WARMACE: {
        materialNames: METAL_WEAPON_MATERIAL_NAMES,
        slots: [
            {index: 0, source: [23, 23, 23], role: 'head mid'},
        ...
        // materialId: 1 steel, 2 pyroxide, 3 geonite, 4 mythril, 5 chaotite
        materialColors: [
            [[120, 144, 161], [54, 67, 82], [194, 219, 232], [42, 18, 12], [91, 43, 25]],
            [[161, 37, 29], [76, 12, 17], [255, 126, 58], [40, 12, 10], [88, 24, 16]],
            [[26, 132, 90], [13, 58, 45], [101, 224, 158], [18, 38, 23], [41, 82, 43]],
            [[32, 126, 202], [6, 34, 105], [111, 236, 255], [79, 49, 8], [175, 127, 24]],
            [[157, 30, 169], [61, 10, 84], [255, 98, 218], [39, 5, 52], [100, 14, 109]],
        ],
        twoSided: true,
    },
}
