...
export function getHamburgerMenuSvg(className: string, id: string) {
    return `
<svg class="${className} noselect" id="${id}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path d="M0 0h512v512H0z" fill="#3c3c3c" fill-opacity="0"></path>
            <g  transform="translate(34,19)"><path d="M32 96v64h448V96H32zm0 128v64h448v-64H32zm0 128v64h448v-64H32z" fill-opacity="1"></path></g>
        </svg>
`
}

// INSPECT SVG
export function getInspectSvg(className: string, id: string) {
    return `
<svg class="${className} noselect" id="${id}" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" >
    <g id="🔍-System-Icons" stroke="none" stroke-width="1" >
        <g id="ic_fluent_inspect_24_regular">
            <path d="M11.1950893,10.1463676 L11.2803,10.2197 L18.7803,17.7197 C19.015,17.9544 19.0675,18.3154 18.9095,18.6073 C18.7689667,18.8666778 18.491742,19.0165444 18.203754,18.9986064 L18.0955,18.9839 L13.8348,18.0869 L11.368,21.6749 C11.1819,21.9456 10.8413,22.0637 10.5275,21.9663 C10.2486556,21.8796333 10.0487444,21.6406309 10.0077623,21.3578731 L10,21.25 L10,10.75 C10,10.4467 10.1827,10.1732 10.463,10.0571 C10.708175,9.95553875 10.9858125,9.99197375 11.1950893,10.1463676 Z M11.5,12.5607 L11.5,18.8353 L12.882,16.8251 C13.0320625,16.6067875 13.2841063,16.4861688 13.5432703,16.5012283 L13.6545,16.5161 L15.9357,16.9964 L11.5,12.5607 Z M19.5,4 C20.8807,4 22,5.11929 22,6.5 L22,15.5 C22,16.7183 21.1285,17.7331 19.975,17.9549 C19.9,17.5176 19.6598,17.1137 19.2849,16.8388 L18.9461,16.5 L19.5,16.5 C20.0523,16.5 20.5,16.0523 20.5,15.5 L20.5,6.5 C20.5,5.94772 20.0523,5.5 19.5,5.5 L4.5,5.5 C3.94772,5.5 3.5,5.94772 3.5,6.5 L3.5,15.5 C3.5,16.0523 3.94772,16.5 4.5,16.5 L9,16.5 L9,18 L4.5,18 C3.11929,18 2,16.8807 2,15.5 L2,6.5 C2,5.11929 3.11929,4 4.5,4 L19.5,4 Z" id="🎨-Color">
...
// LOCK TARGET SVG
export function getTargetLockSvg(className: string, id: string) {
    return `
<svg class="${className} noselect" id="${id}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"  xml:space="preserve">
<g>
...
// STOP ACTION SVG
export function getStopActionSvg(className: string, id: string) {
    return `
<svg class="${className} noselect" id="${id}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96"  xml:space="preserve">
<g>
